...
public class EventListAdaptor extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView startTime = convertView.findViewById(R.id.start);
        TextView endTime = convertView.findViewById(R.id.end);

        title.setText(eventList.get(position).getEventName());
        startTime.setText(eventList.get(position).getStartTime());
        endTime.setText(eventList.get(position).getEndTime());
